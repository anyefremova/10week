...
console.log(printMessage("Привет!"));
...
console.log(secondFunction(6, 14));
...
console.log(thirdFunction(4)); //Выведет 16
...
function GuestNameGreeting(guestName = 'Гость') {
	return `Привет, ${guestName}!`
}

console.log(GuestNameGreeting());
console.log(GuestNameGreeting('Аня'))
...
let calculateSquare = (num) => result = num ** 2
...
function calculateYearsSinceLastOlympics() {
	return nowYear - lastOlympicsYear;
}
...
function calculateAge() {
	return nowYear - friendYearOfBirth;
};

console.log('Ваш возраст - ' + calculateAge() + ' лет');
...
console.log('Результат: ' + result(4, 2));